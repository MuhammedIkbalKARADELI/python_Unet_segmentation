...
#   ikbalkrdl@Ikbal-MacBook-Pro lecture-1 % python3 --version
#   Python 3.13.2
#   ikbalkrdl@Ikbal-MacBook-Pro lecture-1 % python --version
#   Python 3.9.6
#   ikbalkrdl@Ikbal-MacBook-Pro lecture-1 % python3 src/main.py